...
CONFIG_PATH = "configs/parametric_edge/curve_dab_overfit8_cluster_v3_1gpu.yaml"
SBATCH_PATH = f"{CLUSTER_REPO}/cluster_tasks/curve_dab_overfit8_cluster_v3_1gpu.sbatch"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Print or submit the 1-GPU 8-sample curve DAB overfit job.")
