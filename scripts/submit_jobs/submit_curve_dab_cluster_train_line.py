...
CONFIG_PATH = "configs/parametric_edge/laion_curve_pretrain_cluster_v3_2gpu_line.yaml"
SBATCH_PATH = f"{CLUSTER_REPO}/cluster_tasks/train_curve_dab_v3_2gpu_line.sbatch"
...
def build_sbatch() -> str:
    return dedent(
        f"""\
        #!/usr/bin/env bash
        #SBATCH -J curve-dab-v3-2gpu-line
        #SBATCH -p gbunchQ
        #SBATCH --gres=gpu:2
        #SBATCH -c 32
        #SBATCH --mem=64G
