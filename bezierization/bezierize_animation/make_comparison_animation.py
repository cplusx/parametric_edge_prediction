...
from bezierization.bezier_versions.v1_hybrid_initial import DEFAULT_CONFIG as V1_CONFIG, VERSION_NAME as V1_NAME
from bezierization.bezier_versions.v2_dense_sampling import DEFAULT_CONFIG as V2_CONFIG, VERSION_NAME as V2_NAME
from bezierization.bezier_versions.v3_trivial_filter import DEFAULT_CONFIG as V3_CONFIG, VERSION_NAME as V3_NAME
from bezierization.bezier_versions.v4_current import DEFAULT_CONFIG as V4_CONFIG, VERSION_NAME as V4_NAME
from bezierization.bezier_versions.v5_human_split import DEFAULT_CONFIG as V5_CONFIG, VERSION_NAME as V5_NAME
...
def build_version_stages(image_path, config):
    ...
    if config.get('enable_easy_merge', False):
        from bezierization.bezier_refiner_core import merge_easy_adjacent_segments
        merged_paths = []
        for path_fit in fitted_paths:
