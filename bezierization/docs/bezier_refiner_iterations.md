...
## File Layout
- [original_bezierization/edge_refiner.py](/Users/jiaxincheng/Desktop/expts/parametric_edge_prediction/original_bezierization/edge_refiner.py): original graph/junction/edge-splitting code without Bezier fitting.
- [bezierization/bezier_refiner_core.py](/Users/jiaxincheng/Desktop/expts/parametric_edge_prediction/bezierization/bezier_refiner_core.py): shared Bezier fitting implementation.
- `bezierization/bezier_versions/`: ablation versions with a unified `run_refiner(image_path, output_dir=None, **overrides)` interface.
- [bezierization/edge_refiner.py](/Users/jiaxincheng/Desktop/expts/parametric_edge_prediction/bezierization/edge_refiner.py): compatibility entrypoint for the current default version, currently `v5_anchor_consistent`.
- [bezierization/ablation_api.py](/Users/jiaxincheng/Desktop/expts/parametric_edge_prediction/bezierization/ablation_api.py): version loader and unified runtime API.
...
### Original Baseline
- File: [original_bezierization/edge_refiner.py](/Users/jiaxincheng/Desktop/expts/parametric_edge_prediction/original_bezierization/edge_refiner.py)
- Observation:
...
### V1: Greedy Hybrid
- File: [bezier_versions/v1_hybrid_initial.py](/Users/jiaxincheng/Desktop/expts/parametric_edge_prediction/bezierization/bezier_versions/v1_hybrid_initial.py)
- Observation:
...
### V2: Tiny Cleanup
- File: [bezier_versions/v2_dense_sampling.py](/Users/jiaxincheng/Desktop/expts/parametric_edge_prediction/bezierization/bezier_versions/v2_dense_sampling.py)
- Observation:
...
### V3: Trivial Pruned
- File: [bezier_versions/v3_trivial_filter.py](/Users/jiaxincheng/Desktop/expts/parametric_edge_prediction/bezierization/bezier_versions/v3_trivial_filter.py)
- Observation:
...
### V4: Adjacent Merge
- File: [bezier_versions/v4_current.py](/Users/jiaxincheng/Desktop/expts/parametric_edge_prediction/bezierization/bezier_versions/v4_current.py)
- Observation:
...
- File: [bezier_versions/v5_human_split.py](/Users/jiaxincheng/Desktop/expts/parametric_edge_prediction/bezierization/bezier_versions/v5_human_split.py)
- Observation:
